...
public class EditarPerfil {
	 ...
	 */
	public EditarPerfil(PerfilUsuario perfil) {
		this.perfil = perfil;
		initialize();
	}
	...
	private void initialize() {
		...
		frmEditarPerfil.setIconImage(Toolkit.getDefaultToolkit().getImage(EditarPerfil.class.getResource("/Recursos/image.png")));
...
//		panel_10.add(fileChooser);
	...
	private void volverPerfil() {
		...
		perfil.frmPhototds.setVisible(true);
	}
